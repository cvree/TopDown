...
| **Retry the moment** | Restart the task. | **Rewind up to 10 seconds**, save/load any lane state, shareable scenario codes. Possible because our simulation is deterministic. | Rewind round-trip test: the same state produces the same future. |
