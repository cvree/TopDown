...
export const DRILLS: Record<DrillId, DrillMeta> = {
  ...
  vayneTumble: {
    ...
    brief:
      'Attack, tumble out of the backswing, attack again. Never tumble mid-windup, never sit on the cooldown. Flash is on the bar, and spending it is not cheating — it is the other half of the same question.',
  ...
  vayneCondemn: {
    ...
    brief:
      'Chargers come from every angle. Stand so the terrain is behind them, then condemn them into it — and when the angle is not there, tumble until it is. Both cooldowns are charged at the practice rate so the pair is up together often enough to rehearse.',
    transfers: 'Wall-side positioning, and the roll that creates it — the difference between a knockback and a 1.5s stun.',
    group: 'VAYNE',
  ...
  vayneHunt: {
    ...
    brief:
      'Fog of war, terrain, bushes, the full kit including Final Hour, a trinket to buy vision with, and a floor that refills the moment you clear it. You have to find the fight before you can win it.',
  ...
  caitlynDodge: {
    ...
    brief:
      'One Caitlyn, her whole kit, and yours. The Peacemaker draws its lane on the floor for six tenths of a second before it fires, the traps deal no damage and cost you the dodge afterwards, and nothing you do with your feet beats the ultimate — only a wall does. She reaches a hundred units further than you, so every trade has to be taken and left on purpose.',
    transfers:
      'A whole matchup rather than a pattern: moving on the cast instead of on the missile, reading the ground you are walking onto, breaking line of sight against a lock-on, and knowing which of your four buttons answers each of her four.',
    group: 'CAITLYN',
